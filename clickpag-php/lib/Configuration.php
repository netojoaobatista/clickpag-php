...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.clickpagclickpag.com.br';
    ...
    /**
     * User agent of the HTTP request, set to "PHP-Clickpag" by default
     *
     * @var string
     */
    protected $userAgent = "PHP-Clickpag/1.0.0";
    ...
    {
        $report  = "PHP SDK (Clickpag) Debug Report:\n";
        $report .= "    OS: ".php_uname()."\n";
